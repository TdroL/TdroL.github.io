const NAMESPACE = 'stencil-custom-elements-watch-bug';
...
const loadModule = (cmpMeta, hostRef, hmrVersionId) => {
    ...
    return __sc_import_stencil_custom_elements_watch_bug(
...
const patchEsm = () => {
    ...
    if ( !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return __sc_import_stencil_custom_elements_watch_bug(/* webpackChunkName: "polyfills-css-shim" */ './p-1b2d9a2e.js').then(() => {
...
const patchBrowser = () => {
    ...
    }
    {
        ...
        if ( !win.customElements) {
            ...
            // @ts-ignore
            return __sc_import_stencil_custom_elements_watch_bug(/* webpackChunkName: "polyfills-dom" */ './p-2e1bb10c.js').then(() => opts);
        }
    }
