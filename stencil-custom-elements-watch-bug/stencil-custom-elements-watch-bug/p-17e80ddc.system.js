...
System.register([], function (exports, module) {
    ...
    return {
        execute: function () {
            var _this = this;
            var NAMESPACE = 'stencil-custom-elements-watch-bug';
            var scopeId;
            var hostTagName;
            ...
            var scheduleUpdate = function (hostRef, isInitialLoad) {
                ...
                var dispatch = function () { return dispatchHooks(hostRef); };
            ...
            var patchEsm = exports('a', function () {
                ...
                if (!(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
                    // @ts-ignore
                    return module.import(/* webpackChunkName: "polyfills-css-shim" */ './p-b2525e42.system.js').then(function () {
            ...
            var patchBrowser = exports('p', function () {
                ...
                }
                {
                    ...
                    if (!win.customElements) {
                        ...
                        // @ts-ignore
                        return module.import(/* webpackChunkName: "polyfills-dom" */ './p-67940bdc.system.js').then(function () { return opts; });
                    }
                }
